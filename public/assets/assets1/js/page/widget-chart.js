...
$('#visitorMap4').vectorMap(
  {
    ...
    showTooltip: true,
    pins: {
      path01: '<div class="jqvmap-circle" style="background-color:red;font-size:.8em;">1</div>',
      path02: '<div class="jqvmap-circle" style="background-color:red;font-size:.8em;">1</div>',
    },
