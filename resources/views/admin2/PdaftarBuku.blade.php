...
<body class="flex min-h-screen bg-gradient-to-br from-white to-blue-400">
      ...
      <nav class="space-y-4">
        ...
        <div>
          ...
          <div id="submenu-pendaftaran" class="pl-4 space-y-2">
            ...
            <a href="{{ url('/admin2/pendaftaran-buku') }}" class="block p-2 rounded bg-blue-500">Buku</a>
  ...
  <div class="flex-1 p-10">
    <h1 class="text-2xl font-bold text-gray-700 mb-8">Pendaftaran Buku</h1>
    ...
    <div class="w-full max-w-5xl mx-auto bg-[#AADAE6] p-10 rounded-2xl shadow-lg">
      ...
      <form action="{{ url('/admin2/pendaftaran-buku/simpan') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
        @csrf

        <div>
          <label class="block text-gray-700 mb-2">Jenis Buku</label>
          <select name="jenis_buku" required class="w-full p-3 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-400">
        ...
        <div>
          ...
          <input name="judul_buku" type="text" placeholder="Cth: Algoritma dan Pemrograman" required class="w-full p-3 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-400">
        </div>

        <div>
          <label class="block text-gray-700 mb-2">Nama Pencipta</label>
          <input name="nama_pemohon" type="text" placeholder="Cth: Putri Amalia" required class="w-full p-3 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-400">
        </div>
