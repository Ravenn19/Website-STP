            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="{{ route('user.proposalStatus') }}">Proporsal Status</a>
                ...
                <!-- Begin Page Content -->
                    <div class="container mt-5 d-flex justify-content-center">
                        <div class="text-center">
                            ...
                            @if(Auth::user()->proposal_path)
                                <div class="mb-3">
                                    <img style="width: 30%;" src="{{ asset('assets/images/proporsal_image.png') }}"></img>
                                </div>

                                @if(Auth::user()->proposal_approved === 1)
                                    <p class="text-success">✅ Proposal Anda telah disetujui.</p>
                                @elseif(Auth::user()->proposal_approved === 0)
                                    <p class="text-danger">😔🙏😔 <br> Maaf, Proposal Anda tidak disetujui.</p>
                                @else
                                    <p class="text-muted">⏳ Proposal Anda sedang ditinjau.</p>
                                @endif
                            @else
                                <p class="text-warning">🚫 Anda belum mengupload proposal.</p>
                            @endif
                        </div>
