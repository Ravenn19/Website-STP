...
<body id="page-top">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="{{ route('user.profile') }}">Profile</a>
                ...
                <!-- Begin Page Content -->
					<div class="container mt-4">
                        ...
                        <div class="team-details">
                            <div class="row">
                                <div class="col-md-6">
                                    <h3>Anggota Tim</h3>
                                    <ul class="list-group">
                                        <li class="list-group-item"><strong>Ketua:</strong> {{ $user->ketua }}</li>
                                        <li class="list-group-item"><strong>Anggota 1:</strong> {{ $user->anggota1 }}</li>
                                        <li class="list-group-item"><strong>Anggota 2:</strong> {{ $user->anggota2 }}</li>
                                    </ul>
                                </div>
                                <div class="col-md-6">
                                    <h3>Layanan</h3>
                                    <div class="list-group">
                                        @foreach($user->jenis_layanan as $layanan)
                                            <a href="#" class="list-group-item list-group-item-action">{{ $layanan }}</a>
                                        @endforeach
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="list-group">
                                    @if($user->proposal_path)
                                        <div class="d-flex justify-content-between align-items-center list-group-item">
                                            <a href="{{ route('user.download', ['type' => 'proposal']) }}" class="list-group-item list-group-item-action">
                                                Download Proposal
                                            </a>
                                            <button class="btn btn-sm btn-outline-primary" data-bs-toggle="modal" data-bs-target="#editProposalModal">
                                                ✏️
                                            </button>
                                        </div>
                                    @endif
                                    ...
                                    @if($user->profil_startup_path)
                                        <div class="d-flex justify-content-between align-items-center list-group-item">
                                            <a href="{{ route('user.download', ['type' => 'profil_startup']) }}" class="list-group-item list-group-item-action">
                                                Download Profil Startup
                                            </a>
                                            <button class="btn btn-sm btn-outline-primary" data-bs-toggle="modal" data-bs-target="#editProfilModal">
                                                ✏️
                                            </button>
                                        </div>
                                    @endif
                        ...
                        <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-3">
                            <a href="{{ route('user.dashboard') }}" class="btn btn-primary me-md-2">Kembali ke Dashboard</a>
                            <a href="{{ route('user.your-blog') }}" class="btn btn-success">Lihat Blog Saya</a>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="editProposalModal" tabindex="-1" aria-labelledby="editProposalModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <form method="POST" action="{{ route('user.uploadProposal') }}" enctype="multipart/form-data">
            @csrf
            <div class="modal-content border-0 shadow-lg">
                <div class="modal-header bg-primary text-white">
                    <h5 class="modal-title" id="editProposalModalLabel">Upload Proposal</h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body text-center">
                    <div style="border: 2px dashed #6c757d; border-radius: 6px; padding: 15px; margin-bottom: 15px;">
                        <label for="proposal" class="form-label mb-2">Upload file here:</label>
                        <input type="file" name="proposal" id="proposal" accept=".pdf,.doc,.docx" required class="form-control">
                        <div id="proposalFilename" class="mt-2 text-muted" style="font-size: 14px;"></div>
                    </div>
                </div>
                <div class="modal-footer">
    ...
    <!-- Modal Edit Profil Startup -->
    <div class="modal fade" id="editProfilModal" tabindex="-1" aria-labelledby="editProfilModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <form method="POST" action="{{ route('user.uploadProfilStartup') }}" enctype="multipart/form-data">
            @csrf
            <div class="modal-content border-0 shadow-lg">
                <div class="modal-header bg-success text-white">
                    <h5 class="modal-title" id="editProfilModalLabel">Upload Profil Startup</h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body text-center">
                    <div style="border: 2px dashed #6c757d; border-radius: 6px; padding: 15px; margin-bottom: 15px;">
                        <label for="profil_startup" class="form-label mb-2">Upload file here:</label>
                        <input type="file" name="profil_startup" id="profil_startup" accept=".pdf,.doc,.docx" required class="form-control">
                        <div id="profilStartupFilename" class="mt-2 text-muted" style="font-size: 14px;"></div>
                    </div>
                </div>
                <div class="modal-footer">
...
<!-- Bootstrap core JavaScript-->
    ...
    <script>
        document.getElementById('proposal').addEventListener('change', function() {
            ...
            document.getElementById('proposalFilename').textContent = fileName ? `File dipilih: ${fileName}` : '';
        });

        document.getElementById('profil_startup').addEventListener('change', function() {
            const fileName = this.files[0] ? this.files[0].name : '';
            document.getElementById('profilStartupFilename').textContent = fileName ? `File dipilih: ${fileName}` : '';
        });
    </script>
