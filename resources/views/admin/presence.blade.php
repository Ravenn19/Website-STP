...
<head>
    ...
    <style>
        ...
        /* Hanya untuk badge agar text-nya putih */
        .badge {
            color: white !important;
        }

        /* Untuk pagination agar visible di dark background */
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="{{ route('admin.presence') }}">Presence</a>
                    </div>
                </div>
            </li>
                    ...
                    <div>
                        ...
                        <div class="container mt-5">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form method="GET" action="{{ route('admin.presence') }}">
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="mb-3">
                                            ...
                                            <div class="col-md-3">
                                                <div class="mb-3">
                                                    <label class="form-label">&nbsp;</label>
                                                    <div class="d-grid gap-2">
                                                        <a href="{{ route('admin.presence') }}" class="btn btn-danger">
                        ...
                        <div class="container mt-3">
                            <div class="alert alert-info">
                                ...
                                <strong>{{ request('start_date') ?: 'Awal' }}</strong>
                                sampai
                                <strong>{{ request('end_date') ?: 'Sekarang' }}</strong>
                            </div>
                        </div>
                        @endif
                        ...
                        <div class="container mt-4">
                            <h3 style="color: rgb(69, 60, 60);">Riwayat Presensi Semua Tim</h3>
                                ...
                                <table class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        @forelse($presence as $p)
                                            <tr>
                                                <td>{{ $p->user->nama_tim ?? $p->user->name }}</td>
                                                <td>{{ $p->tanggal }}</td>
                                                <td>{{ \Carbon\Carbon::parse($p->waktu_masuk)->format('H:i') }}</td>
                                                <td>
                                                    <span class="badge bg-{{ $p->status == 'Hadir' ? 'success':'warning' }}">
                                                        {{ $p->status }}
                                                    </span>
                                                </td>
                                            </tr>
                        ...
                        <!-- Tabel Rekap Presensi per Tim -->
                        <div class="container mt-5">
                            <h3 style="color: rgb(69, 60, 60);">Rekap Presensi per Tim</h3>
                            <div class="table-responsive mt-3">
                                <table class="table table-bordered table-striped">
                                    <thead class="table-dark">
                                        <tr>
                                    ...
                                    <tbody>
                                        @forelse($teams as $team)
                                            <tr>
                                                <td>{{ $team->nama_tim ?? $team->name }}</td>
                                                <td class="text-center">
                                                    <span class="badge bg-success">{{ $team->total_hadir }}</span>
                                                </td>
                                                <td class="text-center">
                                                    <span class="badge bg-primary">{{ $team->total_presensi }}</span>
                                                </td>
                                                <td class="text-center">
                                                    @php
                                                        $percentage = $team->total_presensi > 0
                                                            ? round(($team->total_hadir / $team->total_presensi) * 100, 2)
                                                            : 0;
                                                        $bgColor = $percentage >= 80 ? 'bg-success' : ($percentage >= 60 ? 'bg-warning' : 'bg-danger');
                                                    @endphp
                                                    <span class="badge {{ $bgColor }}">{{ $percentage }}%</span>
                                                </td>
                                            </tr>
                                        @empty
                                            <tr>
                        ...
                        <!-- Grafik Batang Presensi -->
                        <div class="container mt-5">
                            <h3 style="color: rgb(69, 60, 60);">Grafik Presensi Tim</h3>
            ...
            const presenceChart = new Chart(ctx, {
                ...
                options: {
                    ...
                    plugins: {
                        ...
                        title: {
                            display: true,
                            text: 'Statistik Presensi per Tim'
                        }
                    }
                }
            });

            // Toggle untuk garis total presensi
            document.getElementById('toggleTotalLine').addEventListener('change', function() {
                const isHidden = !this.checked;
                presenceChart.data.datasets[1].hidden = isHidden;
